...
def new_user_hander(phone: str, message_id: str, content:str=None, resp=None):
	...
	# TODO: get create and use a flow message payload for this
	payload = None

	Message.bot_message_flow(text, user, current_intent=CurrentIntentChoices.SET_PREFERENCE, payload=payload)
	return True
